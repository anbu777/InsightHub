...
// ... (Salin kode komponen preview dari respons sebelumnya) ...
...
<<<<<<< HEAD
        <>
            <div className="flex justify-between items-center mb-6">
                ...
                >
                    {isSyncing ? 'Memproses...' : 'Sinkronkan Data Supabase'}
                </button>
=======
        ...
        <div className="space-y-8">
            <div className="flex justify-between items-center">
                 <h1 className="text-3xl font-bold text-gray-800">Dashboard</h1>
                 <button onClick={handleSync} disabled={isSyncing} className="...">
              ...
              <div className="bg-white rounded-xl shadow-md p-6">
                 <div className="flex justify-between items-center mb-4">
                    <h3 className="text-xl font-semibold text-gray-700">Feedback Terbaru</h3>
                     <Link href="/feedback" className="text-sm text-blue-600 hover:underline flex items-center gap-1">
                        Lihat Semua <FaExternalLinkAlt size={12}/>
                    </Link>
                 </div>
