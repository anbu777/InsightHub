...
export default function PageSections({ featuredData, latestData, sortedUnors, beritaData }) {
    ...
    return (
        <div className="p-6 flex flex-col gap-8">
            ...
            <section ref={newsRef} id="news-section" className="scroll-mt-28 bg-white rounded-xl shadow-lg p-8 md:p-12">
                <div className="container mx-auto">
                    <Link href="/berita" className="absolute top-8 right-8 text-sm font-semibold text-[#0D2A57] hover:underline">
                        Lihat Semua &rarr;
                    </Link>
                </div>
            ...
            <section ref={unorRef} id="unor-section" className="relative scroll-mt-28 bg-white rounded-xl shadow-lg p-8 md:p-12">
                <div className="container mx-auto">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 mt-2">Temukan data spesifik dari setiap Unit Organisasi di Kementerian PU.</p>
                    </div>
