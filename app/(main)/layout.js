...
function SmartHeader() {
    ...
    return (
        <header className="text-white shadow-lg sticky top-0 z-50 bg-gradient-to-b from-blue-900 to-blue-800">
            {/* [REVISI] Padding vertikal (py-3) dihapus agar header menyesuaikan tinggi logo */}
                    ...
                    <div className="flex-1 flex justify-start">
                        <Link href="/">
                            <Image 
                                ...
                                width={336}  // [REVISI] Ukuran diperbesar 2x
                                height={112} // [REVISI] Ukuran diperbesar 2x
                                className="h-28 w-auto" // [REVISI] Ukuran diperbesar 2x (dari h-14 ke h-28)
                                priority 
                            />
                        </Link>
                    </div>
